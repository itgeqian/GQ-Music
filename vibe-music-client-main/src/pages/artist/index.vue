...
<template>
  <div class="flex h-full">
    <div class="w-64 p-4 bg-transparent">
    ...
    <main class="flex-1">
      <div class="p-2 md:p-4 lg:p-6">
        <div class="w-[86%] mx-auto">
          <div v-if="artistList.length > 0" class="grid grid-cols-4 gap-x-16 gap-y-8">
          ...
          <div v-else class="w-full py-16 text-center text-muted-foreground">
            没有找到匹配的歌手
          </div>
        </div>
      </div>
