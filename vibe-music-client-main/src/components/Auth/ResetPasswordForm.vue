...
import { sendEmailCode, resetPassword, getCaptcha } from '@/api/system'
...
const refreshCaptcha = async () => {
  ...
  try {
    ...
    if (res && res.code === 0 && res.data) {
      ...
      resetForm.checkCodeKey = data.checkCodeKey
      resetForm.checkCode = ''
    }
  } finally {
    ...
    <el-form ref="resetFormRef" :model="resetForm" :rules="resetRules" label-width="0" size="large"
      ...
      <el-form-item prop="checkCode" class="mt-6">
        <div style="display:flex; gap:8px; align-items:center; width:100%">
          <el-input v-model="resetForm.checkCode" placeholder="图形验证码" />
