...
public class BannerServiceImpl extends ServiceImpl<BannerMapper, Banner> implements IBannerService {
    ...
    public Result addBanner(String bannerUrl, Long albumId) {
        Banner banner = new Banner();
        banner.setBannerUrl(bannerUrl).setBannerStatus(BannerStatusEnum.ENABLE);
        if (albumId != null) banner.setAlbumId(albumId);
    ...
    @Override
    @CacheEvict(cacheNames = "bannerCache", allEntries = true)
    public Result updateBanner(Long bannerId, String bannerUrl, Long albumId) {
